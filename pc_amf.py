...
3 graphs for after seasons - Blue Grosbeak
...
#----------------------------------------------------------------------
mask1 = (dt['eventDate']>='2016-11-5')&(dt['eventDate']<='2017-3-29')
fig1 = Figure(figsize=(7,4),dpi=100)
ax1=fig1.add_subplot(111)
dt.loc[mask1].plot(x='eventDate',y='decimalLatitude',ax=ax1,title="Data from November 2016 to March 2017 after nesting season")
...
mask2 = (dt['eventDate']>='2017-11-13')&(dt['eventDate']<='2018-3-28')
fig2 = Figure(figsize=(7,4),dpi=100)
ax2=fig2.add_subplot(111)
dt.loc[mask2].plot(x='eventDate',y='decimalLatitude',ax=ax2,title="Data from November 2017 to March 2018 after nesting season")
...
mask3 = (dt['eventDate']>='2018-11-12')&(dt['eventDate']<='2019-3-14')
fig3 = Figure(figsize=(7,4),dpi=100)
ax3=fig3.add_subplot(111)
dt.loc[mask3].plot(x='eventDate',y='decimalLatitude',ax=ax3,title="Data from November 2018 to April 2019 after nesting season")
